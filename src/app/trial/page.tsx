...
import { FileText, Users, Video, Plus, Camera } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    title: "イベント写真管理",
    source: "MC Marketing AI",
    description: "イベントや社内行事の写真を一元管理。公開範囲の設定やダウンロード管理も簡単に行えます。",
    comingSoon: false,
  },
  {
                  ...
                  <div className="flex-1">
                    ...
                    {feature.source && (
                      <p className="text-xs text-primary mb-2">
                        {feature.source} の一部を体験版として試用
                      </p>
                    )}
                    <p className={`text-sm ${feature.comingSoon ? "text-gray-400" : "text-text-light"}`}>
                      {feature.description}
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-text-light">CMS・社員肖像管理・イベント写真管理・セミナー配信管理から、必要な機能を有効化します。</p>
                </div>
              </div>
              <div className="flex gap-6 items-start">
                <div className="w-12 h-12 bg-secondary text-white rounded-full flex items-center justify-center font-bold shrink-0">
